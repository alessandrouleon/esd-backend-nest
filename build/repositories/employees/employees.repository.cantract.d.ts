...
export declare class ISearchEmployeesValue {
    unifiedValue: string;
}
export default interface IEmployeesRepository {
    ...
    searchEmployeesCaseFormatDate(parametersToPaginate: PaginatedDto, data: ISearchWithColumn): Promise<IEmployeesReturnWithPagination>;
    findAllEmployeesWithPagination(parametersToPaginate: PaginatedDto): Promise<IEmployeesReturnWithPagination>;
}
