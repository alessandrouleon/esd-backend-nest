...
export declare class ISearchLineValue {
    unifiedValue: string;
}
export default interface ILinesRepository {
    ...
    searchLinesCaseFormatDate(parametersToPaginate: PaginatedDto, data: ISearchWithColumn): Promise<ILinesReturnWithPagination>;
    findAllLinesWithPagination(parametersToPaginate: PaginatedDto): Promise<ILinesReturnWithPagination>;
}
